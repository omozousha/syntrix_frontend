...
export function DeviceBentoQrTile({
  ...
  return (
    <Card className="flex flex-col items-center justify-between rounded-2xl border-border/60 shadow-xs glass-inset text-center">
      <CardContent className="w-full p-5 sm:p-6 flex flex-col justify-between h-full">
