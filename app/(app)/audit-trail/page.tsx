...
const ACTION_LABELS: Record<string, string> = {
  ...
  validation_request_submitted_by_adminregion: "Adminregion submit validasi device",
  asset_create_request_submitted_by_adminregion: "Adminregion submit create asset",
  asset_update_request_submitted_by_adminregion: "Adminregion submit update asset",
  validation_request_approved_by_adminregion: "Adminregion approve validasi device",
  validation_request_rejected_by_adminregion: "Adminregion reject validasi device",
  validation_request_resubmitted_by_adminregion: "Adminregion resubmit validasi device",
