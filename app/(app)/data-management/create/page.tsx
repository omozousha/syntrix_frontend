...
export default function CreateDataManagementPage() {
  ...
  const [form, setForm] = useState(() => {
    let initialDeviceType = "OLT";
    if (typeof window !== "undefined") {
      const params = new URLSearchParams(window.location.search);
      initialDeviceType = (params.get("type") || "OLT").toUpperCase();
    }
    const passive = PASSIVE_TYPES.has(initialDeviceType);
    return {
      pop_name: "",
      pop_code: "",
      tenant: "",
  ...
  useEffect(() => {
    setForm((prev) => {
      if (prev.device_type_key === deviceType) return prev;
      return {
        ...prev,
        ...
        used_ports: "",
        splitter_ratio: "",
        odp_type: prev.odp_type && deviceType === "ODP" ? prev.odp_type : "",
        installation_type: prev.installation_type && deviceType === "ODP" ? prev.installation_type : "",
        cable_type: prev.cable_type && deviceType === "CABLE" ? prev.cable_type : "",
        cable_category: prev.cable_category && deviceType === "CABLE" ? prev.cable_category : "",
        cable_length_m: prev.cable_length_m && deviceType === "CABLE" ? prev.cable_length_m : "",
        route_name: prev.route_name && deviceType === "CABLE" ? prev.route_name : "",
        route_type: prev.route_type && deviceType === "CABLE" ? prev.route_type : "",
        route_coordinates: prev.route_coordinates && deviceType === "CABLE" ? prev.route_coordinates : "",
        route_file_url: prev.route_file_url && deviceType === "CABLE" ? prev.route_file_url : "",
        feeder_port_count: prev.feeder_port_count && deviceType === "ODC" ? prev.feeder_port_count : "",
        distribution_port_count: prev.distribution_port_count && deviceType === "ODC" ? prev.distribution_port_count : "",
        management_ip: prev.management_ip && ["OLT", "ONT", "SWITCH", "ROUTER"].includes(deviceType) ? prev.management_ip : "",
        front_device_id: "",
        front_port_id: "",
        rear_device_id: "",
        rear_port_id: "",
